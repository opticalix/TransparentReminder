package com.opticalix.download;
 ...
 * <li>{@link DownloadManagerPro.RequestPro#setNotiClass(String)} set noti class</li>
 * <li>{@link DownloadManagerPro.RequestPro#setNotiExtras(String)} set noti extras</li>
 * </ul>
 * 
...
public class DownloadManagerPro {
    ...
    public static final Uri    CONTENT_URI                 = Uri.parse("content://downloads/my_downloads"); //系统规定
    ...
    /**
     * get download status. use DownloadManager.Query
     * 
     * @param downloadId
     * @return
     */
